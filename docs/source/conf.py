# -*- coding: utf-8 -*-
#
# openregistry.lots.basic documentation build configuration file, created by
...
htmlhelp_basename = 'openregistrylotslokidoc'
...
latex_documents = [
  ('index', 'openregistrylotsloki.tex', u'openregistry.lots.loki Documentation',
...
man_pages = [
    ('index', 'openregistrylotsloki', u'openregistry.lots.basic Documentation',
...
texinfo_documents = [
  ('index', 'openregistrylotsloki', u'openregistry.lots.loki Documentation',
